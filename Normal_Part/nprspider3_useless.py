#-*-coding:utf-8-*-
# add more data from '12-31-2015' 1000 to 1500
import requests
...
#        if start>=1515:
#            break
    with open('./pages3/cat_'+g+'_pages3.pc','wb') as f:
        pc.dump(pages,f)
...
booklist2={}
for g in genres:
    with open('./pages3/cat_'+g+'_pages3.pc','rb') as f:
        pages=pc.load(f)
    index_in_origen=0
    for pg in pages:
...
###!!!!!
# The result is {}!!!! So we do not have new books!
###!!!!!
